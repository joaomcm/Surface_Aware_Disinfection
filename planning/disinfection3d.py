...
from .tsp_solver_wrapper import runTSP
...
class DisinfectionProblem:
    ...
    def perform_experiment(self,results_dir = './3D_results',mesh_file = './remeshed_hospital_room_full_70k.obj',from_scratch = True,irradiance_from_scratch = True,
        ...
        tour = runTSP(distances, '/{}_currTSP'.format(self.robot_name)) # We just have an arbitrary name since it doesn't matter - can change this so that user can input filename if desired
